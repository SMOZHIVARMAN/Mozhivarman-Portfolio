...
const SocialLinks: React.FC = () => {
  ...
  const codingPlatforms = [
    {
      name: 'LeetCode',
      url: 'https://leetcode.com/u/mozhivarman-official/',
      icon: Code,
    ...
    },
    {
      ...
      icon: Trophy,
      color: 'from-green-1000 to-emerald-1000',
  ...
  return (
    <div className="min-h-screen py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div>
              ...
              >
                mozhivarmanofficial@gmail.com
              </a>
            </div>
            <div>
              <div className="font-semibold">Location</div>
              <div className={isDark ? 'text-gray-400' : 'text-gray-600'}>Chennai, India</div>
            </div>
            <div>
              <div className="font-semibold">Status</div>
              <div className="text-green-500">Available for opportunities</div>
            </div>
          </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {socialPlatforms.map((platform, index) => (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl bg-gradient-to-r ${platform.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {codingPlatforms.map((platform, index) => (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <span className="text-xs font-medium text-blue-500">{platform.stats}</span>
        ...
        >
          <div className={`inline-block p-6 rounded-xl ${isDark ? 'bg-gray-800/50' : 'bg-gray-100/50'}`}>
