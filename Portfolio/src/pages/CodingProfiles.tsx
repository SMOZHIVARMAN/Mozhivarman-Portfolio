            ...
            >
              ...
              <div className="text-center">
                <div className="relative mb-4">
                  {/* ✅ Opacity changed from 20 to 80 */}
                  <div className={`w-16 h-16 mx-auto rounded-xl bg-gradient-to-r ${platform.color} opacity-80 flex items-center justify-center mb-4`}>
