        ...
        <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="p-6 border-b border-gray-700">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex space-x-2">
                    <a
                      href="https://drive.google.com/file/d/1ZDXNnr1Fk4WZCib1_Ykcssar9Uup-7ve/view?usp=sharing"
                      target="_blank"
                    ...
                    <a
                      href="https://drive.google.com/file/d/1xECIjZ3C8SDe_pUQeZUmSgcWDBDFi-AL/view?usp=sharing"
                      target="_blank"
                      rel="noopener noreferrer"
              ...
              <div className={`p-8 space-y-8 ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>
                ...
                <div className={`text-center border-b pb-6 ${isDark ? 'border-gray-600' : 'border-gray-300'}`}>
                  ...
                  <div className={`flex justify-center space-x-4 mt-3 text-sm ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                    <span>mozhivarmanofficial@gmail.com</span>
                    <span>•</span>
          ...
          >
            ...
            <div className={`p-6 rounded-xl ${
              ...
              <a
                href="mailto:mozhivarmanofficisl@gmail.com"
